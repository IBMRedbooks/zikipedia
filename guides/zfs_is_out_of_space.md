...
1. First, make sure `/usr/sbin/` is in your `$PATH` variable in USS. You can easily do this by adding it to your `.profile` in USS. Here is an example:<br><br>
...
2. Next, allocate and format the new ZFS to the size you need.<br><br>
...
3. Next, instead of playing games with ZFS swapping and copying, etc... just run this job:<br><br>
